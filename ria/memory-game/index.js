$(function(){
  ...
  $('.play').on('click', function(){
    ...
    $('.logo').fadeOut(250, function(){
      ...
      var image_array = ['0-cuddles', '1-cute-selfies', '2-dance', '3-feast-on-food', '4-feel-buttcheeks', '5-flowers', 
      '6-give-hoodie', '7-give-kissie', '8-give-sushi', '9-sex', '10-spoon', '11-take-photo', '12-video-call', '13-watch-movie', 
      '14-fly-like-a-bird', '15-lip-lock-kissie', '16-love-letter', '17-healing-touch']
      for(i = 0; i < shu.length; i++){
        ...
        $('<div class="card" style="width:'+cardSize+'%;height:'+cardSize+'%;">'+
            '<div class="flipper"><div class="f"></div><div class="b" data-f="'+code+'" data-ff="'+4*code+'"><center>'+
            '<img src="images/'+image_array[code]+'.png" class="imageclass"></img></center></div></div>'+
          '</div>').appendTo('#g');
      }
