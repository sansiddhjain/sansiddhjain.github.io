...
var textureCandleDif = 'https://crossorigin.me/http://andre-anjos.com/projects/cakeIsALie/imgs/candle_DIF.png'; //Path for diffuse texture
var textureCandleBump = 'https://crossorigin.me/http://andre-anjos.com/projects/cakeIsALie/imgs/candle_BUMP.png'; //Path for bump texture
var textureFlameCandleDif = 'https://crossorigin.me/http://andre-anjos.com/projects/cakeIsALie/imgs/candleFlame_DIF.png';
var textureFlameCandleALPHA = 'https://crossorigin.me/http://andre-anjos.com/projects/cakeIsALie/imgs/candleFlame_ALPHA.png';
...
function changeName() {
  ...
  if ( document.getElementById('changeName-btn').innerHTML === 'Put Icing' ) {
    
    var inputName = "Sanskriti";
    cakeName( inputName );
    document.getElementById('changeName-btn').innerHTML = 'Remove Icing';
    
  } else {
    
    var inputName = "";
    cakeName( inputName );
    document.getElementById('changeName-btn').innerHTML = 'Put Icing';
